...
const productsData = [
  // ==================== OVERSIZED (12 Products) ====================
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1517445312882-bc9910d016b7?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  // ==================== T-SHIRTS (10 Products) ====================
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    sku: 'VAV-TS-003',
    images: [
      'https://images.unsplash.com/photo-1618354691438-25bc04584c23?auto=format&fit=crop&q=80&w=1000',
      'https://images.unsplash.com/photo-1576566588028-4147f3842f27?auto=format&fit=crop&q=80&w=1000'
    ],
    hoverImage: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1618354691438-25bc04584c23?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  // ==================== SHIRTS (10 Products) ====================
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
      { colorName: 'Sand Beige', hexCode: '#D8CEBE' }
    ],
    inventory: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
      { colorName: 'Espresso Brown', hexCode: '#3C2A21' }
    ],
    inventory: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1578587018452-892bacefd3f2?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
      { colorName: 'Washed Cream', hexCode: '#F4F1EA' }
    ],
    inventory: [
  ...
  },
  {
    ...
    sku: 'VAV-HD-007',
    images: [
      'https://images.unsplash.com/photo-1620799140188-3b2a02fd9a77?auto=format&fit=crop&q=80&w=1000',
      'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=1000'
    ],
    hoverImage: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
  ...
  },
  {
    ...
    hoverImage: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&q=80&w=1000',
    colorVariants: [
...
const seedData = async () => {
  try {
    ...
    console.log(`[Seed]: Success! Populated database with ${productsData.length} premium men's luxury products!`);
    process.exit(0);
  } catch (error) {
